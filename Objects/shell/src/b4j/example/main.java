...
public static RemoteObject _homepage = RemoteObject.declareNull("b4j.example.pagehome");
  public Object[] GetGlobals() {
		return new Object[] {"AppName",main._appname,"AppTitle",main._apptitle,"BANano",main._banano,"fx",main._fx,"HomePage",main._homepage,"Publish",main._publish,"ServerIP",main._serverip,"Version",main._version};
}
}